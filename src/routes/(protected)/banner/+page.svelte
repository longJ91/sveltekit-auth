...
<div class="relative overflow-x-auto shadow-md sm:rounded-lg">
	<table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
		<thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
			<tr>
				...
				<th scope="col" class="px-6 py-3"> Squence </th>
					...
					>
						...
						<td class="px-6 py-4">
							<img
								...
								alt="image description {banner.thumbnailUrl}"
							/>
						</td>
						<td class="px-6 py-4">
							<a href={banner.linkUrl} target="_blank">{banner.linkUrl}</a>
						</td>
						<td class="px-6 py-4"> {banner.status} </td>
						<td class="px-6 py-4"> {banner.sequence} </td>
						<td class="px-6 py-4"> {new Date(banner.createDate)} </td>
						<td class="px-6 py-4"> {new Date(banner.updateDate)} </td>
	...
	>
		...
		<ul class="inline-flex -space-x-px rtl:space-x-reverse text-sm h-8">
			<li>
				<a
					href="/banner?page={previousPage}&windowSize={windowSize}"
			...
			<li>
				<a
					href="/banner?page={nextPage}&windowSize={windowSize}"
