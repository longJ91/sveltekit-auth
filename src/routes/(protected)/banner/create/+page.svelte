...
>
	<div>
		<div class="flex flex-col justify-center px-6 py-12">
			...
			<!-- 
			<div class="mb-6" on:mouseleave={mouseLeaveCountriesButton}>
				<label for="link-url" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
					>Exposures</label
				>
				<div class="flex">
				...
				<div
					id="dropdown"
					class="z-10 bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 {countryGroupHidden} "
							...
							{#each countries as country}
								<li>
									<button
										...
										on:click={() => clickCountryButton(country.code)}
									>
