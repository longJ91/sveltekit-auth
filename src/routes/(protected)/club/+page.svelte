<script lang="ts">
	...
	const clubs: Club[] = data.clubInfoResponse.clubs;

	$: count = data.clubInfoResponse.totalCount;
	$: page = 1;
	$: siblingCount = $isDesktop ? 1 : 0;

	const table = createTable(readable(clubs), {
	...
	const hideableCols = ['id', 'name', 'description', 'status', 'createDate'];
</script>
