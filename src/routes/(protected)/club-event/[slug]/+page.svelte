<script lang="ts">
	...
	export let data;
	let clubEvent = data.clubEvent;

	$: status = true;
	$: checkedShopType = clubEvent.shopType;
	...
	function handleCancel() {
		history.replaceState({}, '', '/club-event');
		invalidateAll();
	}
</script>
	...
	<div>
		<div class="flex flex-col justify-center px-6 py-12">
			<div class="flex flex-col pb-3">
				...
				<dd class="text-lg font-semibold">{clubEvent.id}</dd>
			</div>
			<div class="mb-6">
